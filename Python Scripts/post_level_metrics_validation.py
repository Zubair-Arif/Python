...
def get_api_response(p_user_id, p_password, p_user_choice, p_start_date_arr, p_end_date_arr, p_profile_ids
    ...
    check = p_check
    start_end_date_list = [start_date_arr[0],end_date_arr[0]+timedelta(days=1)]
    ...
    post_metric_body_json = {
        ...
        "date_start": start_date_arr[0],
        "date_end": end_date_arr[0],
    ...
    for i in start_end_date_list:
        ...
        while True:
            ...
            if temp['success'] == True:
                ...
                elapsed_time = (et - st)
                post_metrics_response_nested.append(post_metrics_response)
                return post_metrics_response, total_val,post_metrics_response[0],post_metrics_response_nested[1]

    et = t.time()
    elapsed_time = (et - st)


    return post_metrics_response, total_val,post_metrics_response_nested[0],post_metrics_response_nested[1]
...
def source_target_count_check():
    ...
    post_metrics_response, total_val,post_metrics_response_start,post_metrics_response_end = get_api_response(user_id, password, user_choice, start_date, end_date,
                                                        profile_ids, post_level_metrics, limit, post_level_metrics_sort,
                                                        1)
