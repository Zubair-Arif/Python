...
def read_config(filepath):
    ...
    if SYNC_TYPE == 1:
        ...
        print("Daily Sync-up")
        start_date = d.today() - timedelta(days=3)
...
def main():
    ...
    secret_keys, end_point, start_date, end_date, io_tech_s3_url, brand_vertical_mapping_url = read_config('IO_TECH_ETL_Scripts\config.ini')
