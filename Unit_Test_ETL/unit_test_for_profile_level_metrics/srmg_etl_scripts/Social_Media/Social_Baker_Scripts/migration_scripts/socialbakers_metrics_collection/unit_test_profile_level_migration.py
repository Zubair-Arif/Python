...
class test_profile_migration(test.TestCase):
    def test_read_gen_config(self):
        original_read_gen_config_output = profile_level_metrics_collector.read_gen_config()
    ...
    def test_read_sm_config(self):
        original_sm_config_output = profile_level_metrics_collector.read_sm_config(1)
    ...
    def test_get_brand_vertical_mapping(self):
        original_brand_vertical_output = profile_level_metrics_collector.get_brand_vertical_mapping("s3://srmg-datalake/social_media_metrics/social_bakers/brand_vertical_mapping.json")
    ...
    def test_date_limit_handler(self):
        original_start_date_output, original_end_date_output = profile_level_metrics_collector.date_limit_handler(dt.strptime("2018-01-01", "%Y-%m-%d").date(), dt.strptime("2018-01-01", "%Y-%m-%d").date(), 1)
    ...
    def test_get_api_response(self):
        original_profile_api_response = profile_level_metrics_collector.get_api_response(
            user_id,
            password,
            1,
            [dt.strptime("2018-01-01", "%Y-%m-%d").date()],
    ...
    def test_post_level_metrics_fetcher(self):
        ...
        original_post_level_fetcher_output = profile_level_metrics_collector.post_level_metrics_fetcher(1, profile_api_response, "s3://srmg-datalake-test/test_2/social_bakers/post-level-metrics/")
    ...
    def test_beautify_post_metrics(self):
        ...
        original_beautify_post_metrics_output = profile_level_metrics_collector.beautify_post_metrics(1, brand_vertical_df, post_metrics_response_df)
    ...
    def test_main(self):
        original_main_func_output = profile_level_metrics_collector.main()
